...
from mydet.registry import TASK_UTILS
from mydet.structures.bbox import BaseBoxes, HorizontalBoxes, get_box_tensor
from .base_bbox_coder import BaseBBoxCoder


@TASK_UTILS.register_module()
class LegacyDeltaXYWHBBoxCoder(BaseBBoxCoder):
    """Legacy Delta XYWH BBox coder used in mydet V1.x.
...
def legacy_bbox2delta(
    ...
    """Compute deltas of proposals w.r.t. gt in the mydet V1.x manner.
...
def legacy_delta2bbox(rois: Tensor,
    ...
    """Apply deltas to shift/scale base boxes in the mydet V1.x manner.
    ...
    # the models trained in mydetection 1.X (~0.5 bbox AP, 0.2 mask AP)
    x1 = gx - gw * 0.5
    y1 = gy - gh * 0.5
    x2 = gx + gw * 0.5
    y2 = gy + gh * 0.5
