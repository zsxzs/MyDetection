...
from mydet.structures.bbox import BaseBoxes, cat_boxes
from mydet.utils import util_mixins
from mydet.utils.util_random import ensure_rng
...
class SamplingResult(util_mixins.NiceRepr):
    ...
    Example:
        ...
        >>> from mydet.models.task_modules.samplers.sampling_result import *  # NOQA
    ...
    def random(cls, rng=None, **kwargs):
        ...
        from mydet.models.task_modules.assigners import AssignResult
        from mydet.models.task_modules.samplers import RandomSampler
        rng = ensure_rng(rng)
