...
from mydet.structures.bbox import BaseBoxes
from mydet.structures.mask import BitmapMasks, PolygonMasks
from mydet.utils import ConfigType
...
class Detectron2Wrapper(BaseDetector):
    ...
    mydetection's convention, so a Detectron2 model can be trained and
    evaluated in mydetection.
    ...
    def predict(self, batch_inputs: Tensor,
        ...
        The inputs will first convert to the Detectron2 type and feed into
        D2 models. And the results will convert back to the mydet type.
    ...
    def _convert_to_d2_inputs(self,
        ...
        for image, data_samples in zip(batch_inputs, batch_data_samples):
            ...
            # TODO: use mydet.structures.box.get_box_tensor after PR 8658
            #  has merged
