...
from mydet.structures import OptSampleList
from mydet.utils import OptConfigType
...
class DeformableDETR(DetectionTransformer):
    ...
    def pre_transformer(
        ...
        in `mydet/detector/base_detr.py`.
    ...
    def pre_decoder(self, memory: Tensor, memory_mask: Tensor,
        ...
        if self.as_two_stage:
            ...
            # See https://github.com/open-mmlab/mydetection/blob/master/mydet/models/dense_heads/deformable_detr_head.py#L241 # noqa
