...
from mydet.models.utils import empty_instances
from mydet.registry import MODELS
from mydet.structures.mask import mask_target
from mydet.utils import ConfigType, InstanceList, OptConfigType, OptMultiConfig
...
class FCNMaskHead(BaseModule):
    ...
    def _predict_by_feat_single(self,
        ...
        Example:
            ...
            >>> from mydet.models.roi_heads.mask_heads.fcn_mask_head import *  # NOQA
        ...
        if device.type == 'cpu':
            ...
            # See https://github.com/open-mmlab/mydetection/pull/5191
            num_chunks = int(
