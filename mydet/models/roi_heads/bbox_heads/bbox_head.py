...
from mydet.models.layers import multiclass_nms
from mydet.models.losses import accuracy
from mydet.models.task_modules.samplers import SamplingResult
from mydet.models.utils import empty_instances, multi_apply
from mydet.registry import MODELS, TASK_UTILS
from mydet.structures.bbox import get_box_tensor, scale_boxes
from mydet.utils import ConfigType, InstanceList, OptMultiConfig
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, sampling_results: Union[List[SamplingResult],
        ...
        Example:
            ...
            >>> import numpy as np
            >>> from mydet.models.task_modules.samplers.
