...
from mydet.structures.bbox import bbox_xyxy_to_cxcywh
from mydet.utils import (ConfigType, OptConfigType, OptInstanceList,
...
class YOLOXHead(BaseDenseHead):
    ...
    def loss_by_feat(
        ...
        if num_pos > 0:
            ...
            # https://github.com/open-mmlab/mydetection/issues/7298
