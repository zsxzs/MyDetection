...
class YOLACTHead(AnchorHead):
    ...
    def _bbox_post_process(self,
        ...
        if self.use_sigmoid_cls:
            ...
            # remind that we set FG labels to [0, num_class-1] since mydet v2.0
            # BG cat_id: num_class
...
class SegmentationModule(BaseModule):
    ...
    In mydet v2.x `segm_loss` is calculated in YOLACTSegmHead, while in
    mydet v3.x `SegmentationModule` is used to obtain the predicted semantic
