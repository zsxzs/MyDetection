...
from mydet.models.layers.transformer import inverse_sigmoid
from mydet.models.utils import (filter_scores_and_topk, multi_apply,
                                select_single_mlvl, sigmoid_geometric_mean)
from mydet.registry import MODELS
from mydet.structures.bbox import (cat_boxes, distance2bbox, get_box_tensor,
                                   get_box_wh, scale_boxes)
from mydet.utils import ConfigType, InstanceList, OptInstanceList, reduce_mean
...
class RTMDetInsHead(RTMDetHead):
    ...
    def _predict_by_feat_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, kernel_pred,
            ...
            # After https://github.com/open-mmlab/mydetection/pull/6268/,
